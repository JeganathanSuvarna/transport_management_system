    ...
    <div class="row m-4 p-4">
        <div class="col-md-8">
            ...
            <div class="card-header">
                ...
                <form method="post" action="/schedules" autocomplete="off">
                    <div class="card-body">
                            @csrf
                    ...
                    @else
                        ...
                        @include('alerts.feedback', ['field' => 'route_id'])
                            ...
                            <div class="form-group{{ $errors->has('start_time') ? ' has-danger' : '' }}">
                                ...
                                <input type="time" name="start_time" class="form-control{{ $errors->has('start_time') ? ' is-invalid' : '' }}" placeholder="Start Time" value="{{ old('start_time') }}">
                                @include('alerts.feedback', ['field' => 'start_time'])
                            </div>
                            <div class="form-group{{ $errors->has('end_time') ? ' has-danger' : '' }}">
                                <label>End Time</label>
                                <input type="time" name="end_time"  class="form-control{{ $errors->has('end_time') ? ' is-invalid' : '' }}" placeholder="End Time" value="{{ old('end_time') }}">
